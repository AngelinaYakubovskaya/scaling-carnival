...
int main()
{
    ...
    int alphabetSize;
    cout << "Enter the number of the characters of the alphabet: ";
    cin >> alphabetSize;
    ...
    cout << "Enter the characters of the alphabet separated by space (max " << alphabetSize << "): ";
    ...
    cout << "Enter the string (length " << stringLength << "): ";
    char symbolChar;
    ...
    int alphabetSizeInt;
    cout << "Enter the number of characters of the alphabet: ";
    cin >> alphabetSizeInt;
    ...
    cout << "Enter the cahracters of the alphabet separated by space (max " << alphabetSizeInt << "): ";
    ...
    vector<int> inputInt;
    cout << "Enter the string (length " << IntstringLength << "): (after each symbol push space)";
    int symbolInt;
    ...
    cout << "Enter the characters of the alphabet: ";
    cin >> alphabetString;
